...
<template>
  <div>
    <FaPageHeader title="计数到" description="FaCountTo" />
    <FaCodePreview :code="Demo1Code">
      <Demo1 />
    </FaCodePreview>
    <FaCodePreview title="持续10秒" :code="Demo2Code">
      <Demo2 />
    </FaCodePreview>
    <FaCodePreview title="保留2位小数" :code="Demo3Code">
      <Demo3 />
    </FaCodePreview>
    <FaCodePreview title="带前缀和后缀" :code="Demo4Code">
      <Demo4 />
    </FaCodePreview>
    <FaCodePreview title="手动控制" :code="Demo5Code">
      <Demo5 />
    </FaCodePreview>
  </div>
</template>
