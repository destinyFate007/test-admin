  ...
  <div>
    ...
    <FaPageMain v-if="settingsStore.settings.app.enablePermission" title="鉴权指令">
      <div class="flex-col-start space-y-2">
        <div v-auth="'pages.general:browse'">
          如果你有 pages.general:browse 权限则能看到这句话
        </div>
        <div v-auth="'pages.form:browse'">
          如果你有 pages.form:browse 权限则能看到这句话
        </div>
        <div v-auth="['pages.general:browse', 'pages.form:browse']">
          如果你有 pages.general:browse 或 pages.form:browse 权限则能看到这句话
        </div>
        <div v-auth.all="['pages.general:browse', 'pages.form:browse']">
          如果你有 pages.general:browse 和 pages.form:browse 权限则能看到这句话
        </div>
      </div>
    </FaPageMain>
    <FaPageMain v-if="settingsStore.settings.app.enablePermission" title="鉴权组件">
      <div class="text-sm space-y-2">
        <div>
          你
          <FaAuth value="pages.general:browse">
            <FaKbd>有</FaKbd>
            <template #no-auth>
              <FaKbd>没有</FaKbd>
            </template>
          </FaAuth>
          pages.general:browse 权限
        </div>
        <div>
          你
          <FaAuth value="pages.form:browse">
            <FaKbd>有</FaKbd>
            <template #no-auth>
              <FaKbd>没有</FaKbd>
            </template>
          </FaAuth>
          pages.form:browse 权限
        </div>
        <div>
          你
          <FaAuth :value="['pages.general:browse', 'pages.form:browse']">
            <FaKbd>有</FaKbd>
            <template #no-auth>
              <FaKbd>没有</FaKbd>
            </template>
          </FaAuth>
          pages.general:browse 或 pages.form:browse 权限
        </div>
        <div>
          你
          <FaAuth :value="['pages.general:browse', 'pages.form:browse']" all>
            <FaKbd>有</FaKbd>
            <template #no-auth>
              <FaKbd>没有</FaKbd>
            </template>
          </FaAuth>
          pages.general:browse 和 pages.form:browse 权限
        </div>
      </div>
    </FaPageMain>
