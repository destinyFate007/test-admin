...
import api from '@/api/modules/standardModule'
      ...
      <template #description>
        <div class="space-y-2">
          ...
          <p style="display: flex; align-items: center;">
            ...
            <ElRadioGroup v-model="tableAutoHeight" size="default">
          ...
          <p style="display: flex; align-items: center;">
            ...
            <ElRadioGroup v-model="formMode" size="default">
              <ElRadioButton value="router">
                路由跳转
              </ElRadioButton>
              <ElRadioButton value="modal">
                对话框
              </ElRadioButton>
              <ElRadioButton value="drawer">
                抽屉
              </ElRadioButton>
            </ElRadioGroup>
          </p>
        ...
        <template #default="{ fold, toggle }">
          <ElForm :model="search" size="default" label-width="100px" inline-message inline class="search-form">
            ...
            <ElFormItem v-show="!fold" label="标题2">
              <ElInput v-model="search.title2" placeholder="请输入标题，支持模糊查询" clearable @keydown.enter="currentChange()" @clear="currentChange()" />
            </ElFormItem>
            <ElFormItem v-show="!fold" label="标题3">
              <ElInput v-model="search.title3" placeholder="请输入标题，支持模糊查询" clearable @keydown.enter="currentChange()" @clear="currentChange()" />
            </ElFormItem>
            <ElFormItem v-show="!fold" label="标题4">
              <ElInput v-model="search.title4" placeholder="请输入标题，支持模糊查询" clearable @keydown.enter="currentChange()" @clear="currentChange()" />
            </ElFormItem>
            <ElFormItem>
